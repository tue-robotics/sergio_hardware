...
#ifndef DYNAMIXELCONTROLLERS_HPP
#define DYNAMIXELCONTROLLERS_HPP
...
class DynamixelControllers : public RTT::TaskContext {
	private:
	...
	public:
		DynamixelControllers(const std::string& name);
		~DynamixelControllers(){};
